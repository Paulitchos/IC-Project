...
\subsection{PSO}\label{sec:apre-da-org}
...
\includegraphics[opção]{img/PSO.png}


            

\section{FireFly}\label{sec:an-da-info-fin-da-org}
...
predador que um vaga-lume tem um gosto amargo. 
  ...
  \section{Particle Swarm Otimization. Quais as vantagens e desvantagens?}\label{sec:apre-da-org}
...
\end{enumerate}
\subsection{Descrever em detalhe o algoritmo selecionado e apresentar uma análise comparativamente com a versão base, o PSO \–  }\label{sec:apre-da-org}
